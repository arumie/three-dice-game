  ...
  const awardDefs: AwardDef[] = [
    ...
    ...(() => {
      ...
      return top.roundsLost > 0
        ? [
            {
              label: "Most Losses",
              quip: "Better luck next time",
              icon: Skull,
              color: "text-red-500",
              participantId: top.participantId,
              value: top.roundsLost,
            },
          ]
        : [];
    })(),
    ...
    ...(() => {
      ...
      return top.sipsReceived > 0
        ? [
            {
              label: "Most Targeted",
              quip: "What did you do to them?",
              icon: CircleArrowDown,
              color: "text-orange-500",
              participantId: top.participantId,
              value: top.sipsReceived,
            },
          ]
        : [];
    })(),
    ...(() => {
      const top = [...stats].sort(
        (a, b) => b.threeOfAKindCount - a.threeOfAKindCount,
      )[0];
      return top.threeOfAKindCount > 0
        ? [
            {
              label: "Triple Threat",
              quip: "Three of a kind magnet",
              icon: Dices,
              color: "text-amber-600 dark:text-amber-400",
              participantId: top.participantId,
              value: top.threeOfAKindCount,
            },
          ]
        : [];
    })(),
    ...(() => {
      ...
      return top.stairsCount > 0
        ? [
            {
              label: "Stairway Master",
              quip: "One step at a time",
              icon: Footprints,
              color: "text-blue-500",
              participantId: top.participantId,
              value: top.stairsCount,
            },
          ]
        : [];
    })(),
    ...(() => {
      const top = [...stats].sort(
        (a, b) => b.shitStairsCount - a.shitStairsCount,
      )[0];
      return top.shitStairsCount > 0
        ? [
            {
              label: "Shit Stairs King",
              quip: "Face, meet palm",
              icon: Toilet,
              color: "text-amber-800 dark:text-amber-600",
              participantId: top.participantId,
              value: top.shitStairsCount,
            },
          ]
        : [];
    })(),
    ...(() => {
      const top = [...stats].sort(
        (a, b) => b.lowestScoreCount - a.lowestScoreCount,
      )[0];
      return top.lowestScoreCount > 0
        ? [
            {
              label: "Bottom Roller",
              quip: "Couldn't roll worse if you tried",
              icon: TrendingDown,
              color: "text-amber-600 dark:text-amber-400",
              participantId: top.participantId,
              value: top.lowestScoreCount,
            },
          ]
        : [];
    })(),
    ...(() => {
      const top = [...stats].sort(
        (a, b) => b.tiebreakerWins - a.tiebreakerWins,
      )[0];
      return top.tiebreakerWins > 0
        ? [
            {
              label: "Tiebreaker Champ",
              quip: "Luck favours the bold",
              icon: Crown,
              color: "text-green-500",
              participantId: top.participantId,
              value: top.tiebreakerWins,
            },
          ]
        : [];
    })(),
