...
export function GameRulesDialog() {
  ...
  return (
    <>
      ...
      <Dialog
        open={gameRulesOpen.value}
        onOpenChange={(v) => {
          gameRulesOpen.value = v;
        }}
      >
        <DialogContent className="scrollbar-thin max-h-[85vh] overflow-y-auto sm:max-w-lg">
          ...
          <div className="space-y-5 text-sm">
              ...
              <div className="space-y-2.5">
                ...
                <div className="rounded-md border p-2.5">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    get to play bartender &mdash; pick someone to drink! The
                    number of sips equals your position in the round (1st player
                    = 1 sip, 2nd = 2, etc.).
                  </p>
                </div>
                ...
                <div className="rounded-md border p-2.5">
                  ...
                  <p className="text-muted-foreground">
                    The legendary follow-up! Only works if the player before you
                    rolled Stairs. You&apos;re{" "}
                ...
                <div className="rounded-md border p-2.5">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    make you safe. You can still lose the round on top of it,
                    but hey...{" "}
                    <strong className="text-foreground">
                      at least you're dragging everyone down with you.
                    </strong>
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                The real fun is in the gamble. Re-rolling safe dice to chase a
                three of a kind, keeping a low score hoping everyone else rolls
                worse, or sacrificing a solid hand to go for stairs &mdash;
                fortune favours the bold! The best moments come from daring
                plays that either pay off spectacularly or crash and burn.
              </p>
            </section>
          ...
          <DialogFooter
            showCloseButton
            className="sticky -bottom-6 z-10 -mx-6 -mb-6 bg-background px-6 pb-6 pt-4 border-t border-border"
          />
        </DialogContent>
      </Dialog>
    </>
